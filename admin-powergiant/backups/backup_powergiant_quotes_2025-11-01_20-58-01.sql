...
('1', 'main_title', 'text', 'About Oil Product Industries with Excellence', NULL, '1', '2025-11-01 15:35:43', '2025-11-01 15:35:43'),
('2', 'main_description', 'text', 'POWER GIANT RMT IS A DYNAMIC AND INNOVATIVE ENTERPRISE SPECIALIZING IN TRANSPORT, REFINING AND DISTRIBUTION OF OIL PRODUCTS.', NULL, '2', '2025-11-01 15:35:43', '2025-11-01 15:35:43'),
...
('6', 'main_image', 'image', NULL, 'pages/about.png', '6', '2025-11-01 15:35:43', '2025-11-01 17:30:55'),
('7', 'mission_image', 'image', NULL, 'Mission.png', '7', '2025-11-01 15:35:43', '2025-11-01 15:35:43'),
('8', 'vision_image', 'image', NULL, 'Vission.png', '8', '2025-11-01 15:35:43', '2025-11-01 15:35:43'),
('9', 'quality_image', 'image', NULL, 'Quality.png', '9', '2025-11-01 15:35:43', '2025-11-01 15:35:43'),
('10', 'delivery_image', 'image', NULL, 'Delivery.png', '10', '2025-11-01 15:35:43', '2025-11-01 15:35:43'),
('11', 'process_image', 'image', NULL, 'Process.png', '11', '2025-11-01 15:35:43', '2025-11-01 15:35:43'),
('12', 'certificate_image', 'image', NULL, 'cert.png', '12', '2025-11-01 15:35:43', '2025-11-01 15:35:43');
...
CREATE TABLE `admin_user` (
  ...
  CONSTRAINT `admin_user_ibfk_1` FOREIGN KEY (`id`) REFERENCES `quote_requests` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO `admin_user` VALUES
('1', 'powergiant@gmail.com', '$2y$10$5um.2EQq36EpfWMwAHCcqOS6IT.SHfxXHkmFRAMJymGTWemEhMQvC', 'admin@powergiantrmt.com', 'Administrator', 'admin', '2025-11-01 20:18:12', '2025-10-27 22:25:29', '2025-11-01 20:18:12');
...
('1', 'ISO 9001:2015 Certification', 'Quality Management System Certification ensuring standardized processes and continuous improvement.', 'International Organization for Standardization', '2023-01-15', '2026-01-15', NULL, NULL, '1', '1', '2025-11-01 15:35:43', '2025-11-01 15:35:43'),
('2', 'DOE Accreditation', 'Department of Energy accreditation for oil industry operations and distribution.', 'Department of Energy - Philippines', '2023-03-20', '2025-03-20', NULL, NULL, '2', '1', '2025-11-01 15:35:43', '2025-11-01 15:35:43'),
...
('5', 'Solar-Powered Tanker Fleet Launched', 'Innovative solar-powered tankers set new standards for sustainable fuel transportation.', 'Hybrid solar-diesel tankers reduce fuel use by 30%', 'uploads/news/news_5.jpg', 'Marine Operations', '2025-10-10', '1', '5', '2025-11-01 19:00:27', '2025-11-01 19:00:27'),
...
('1', 'Palm Oil Distribution', 'Premium quality palm oil for food manufacturing, cosmetics, and biofuel industries. Temperature-controlled storage and kulot', 'palm-oil', '', '1', '1', '2025-11-01 13:14:45', '2025-11-01 15:12:49'),
